...
public final class Enumerations {
	...
	*/
	 ...
	 */
	public static <T extends Enum<T>> T parse(@Nullable String str, @NotNull T fallback) {
		try {
	 ...
	 * @return The parsed enum constant.
	 */
	public static <T extends Enum<T>> T parse(@Nullable String str, @NotNull Class<T> clazz, @Nullable T fallback) {
		try {
	...
	public static <T extends Enum<T>> T parse(@Nullable String str, @NotNull Class<T> clazz) {
